...
saveRDS(list(
    ...
    results = results
), "/scratch/bt307958/X1_results.rds")

write.csv(anchor_table, "/scratch/bt307958/X1_anchor_table.csv", row.names = FALSE)
sha_anchor <- system("sha256sum /scratch/bt307958/X1_anchor_table.csv | cut -d\" \" -f1", intern = TRUE)
