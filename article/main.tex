...
Section~\ref{sec:theory} develops the framework and derives the reliability results as formal propositions. Section~\ref{sec:data} describes the data and the construction of the estimating population. Section~\ref{sec:empirical} presents the naive estimator, its diagnostics, and the corrections. Section~\ref{sec:results} reports the corrected distribution, its slope across pair types, the reconciliation of the specification spread, and the identification boundary. Section~\ref{sec:robustness} propagates the distribution through general equilibrium. Section~\ref{sec:conclusion} concludes.
