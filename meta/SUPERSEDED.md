...
- **Issue:** Section 3 of the manuscript asserted robustness across a threshold grid,
  citing output/T30_threshold_grid.csv. That artifact was generated by
  code/S31_threshold_grid.R and committed, but had not been independently re-derived
  from the canonical R-chain inputs.
- **Resolution:** The robustness claim is withdrawn from Section 3. T30 and S31 are
  archived under archive/retired_2026-08-10/ and their FILE_REGISTRY rows are recoded
  from BUILT to ARCHIVED. The manuscript now cites only the four specification-spread
  estimates in T1R_spec_spread.csv, which are R-chain produced and gate-verified.
- **Artifacts moved:**
  - code/S31_threshold_grid.R -> archive/retired_2026-08-10/code/
  - output/T30_threshold_grid.csv -> archive/retired_2026-08-10/output/
  - output/T30_threshold_grid.csv.sidecar -> archive/retired_2026-08-10/meta/
- **Status:** CLOSED
- **Date:** 2026-08-10
